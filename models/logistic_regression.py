...
import keras
from keras.layers import BatchNormalization, Dropout, Dense, TimeDistributed, Masking, Activation, Input, Reshape, Embedding, Bidirectional
...
def build_network(config, input_size, output_dim=1, activation='sigmoid'):
    ...
    out = Dense(output_dim, activation="sigmoid")(mask)
